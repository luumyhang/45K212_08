...
?>
        ...
        <?php } ?>
            ...
            if(isset($_GET['sua']) && ($_GET['id']  == $item[0])){
                echo '  
                <div class="strong">'.$item[1].' </div><span class="by">'.$item[2].'</span> <div class="strong">'.$item[3].''.$linkDel.''.$linkEdit.' <br>';
                ?>
                        ...
                        <div class="new-comment">
                            <input type="text" name="commentsua" placeholder="Nhập bình luận..." /> >
                            <select name="review">
            ...
            <section class="comment">
            <input type="submit" name="btncomment" class="btn btn-primary" value="REVIEW"> 
            </section>
            </form>
